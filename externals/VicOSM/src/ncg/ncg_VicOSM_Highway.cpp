...
void Highway::readXML(const TiXmlElement * element) {
	FUNCID(Highway::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Highway' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Highway' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Highway::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Highway");
