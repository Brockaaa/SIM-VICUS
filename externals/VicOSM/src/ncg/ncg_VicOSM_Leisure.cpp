...
void Leisure::readXML(const TiXmlElement * element) {
	FUNCID(Leisure::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Leisure' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Leisure' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Leisure::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Leisure");
