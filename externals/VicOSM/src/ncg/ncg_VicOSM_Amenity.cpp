...
void Amenity::readXML(const TiXmlElement * element) {
	FUNCID(Amenity::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Amenity' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Amenity' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Amenity::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Amenity");
