...
void Bridge::readXML(const TiXmlElement * element) {
	FUNCID(Bridge::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Bridge' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Bridge' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Bridge::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Bridge");
