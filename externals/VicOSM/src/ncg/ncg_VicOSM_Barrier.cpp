...
void Barrier::readXML(const TiXmlElement * element) {
	FUNCID(Barrier::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Barrier' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Barrier' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Barrier::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Barrier");
