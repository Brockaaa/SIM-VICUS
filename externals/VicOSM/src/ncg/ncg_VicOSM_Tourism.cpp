...
void Tourism::readXML(const TiXmlElement * element) {
	FUNCID(Tourism::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Tourism' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Tourism' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Tourism::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Tourism");
