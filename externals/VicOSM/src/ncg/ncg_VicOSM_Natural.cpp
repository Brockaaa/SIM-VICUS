...
void Natural::readXML(const TiXmlElement * element) {
	FUNCID(Natural::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Natural' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Natural' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Natural::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Natural");
