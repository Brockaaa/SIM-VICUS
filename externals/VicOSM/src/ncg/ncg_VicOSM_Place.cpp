...
void Place::readXML(const TiXmlElement * element) {
	FUNCID(Place::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Place' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Place' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Place::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Place");
