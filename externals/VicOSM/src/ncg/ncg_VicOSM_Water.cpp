...
void Water::readXML(const TiXmlElement * element) {
	FUNCID(Water::readXML);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'Water' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'Water' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * Water::writeXML(TiXmlElement * parent) const {
	TiXmlElement * e = new TiXmlElement("Water");
