...
namespace VICUS {
	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			case 15 :
			switch (t) {
				case 0 : return "Costgroup";
				case 1 : return "Code";
				case 2 : return "Lifetime";
				case 3 : return "ReplacementCycles";
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			case 15 :
			switch (t) {
				case 0 : return "Material cost group";
				case 1 : return "Material Code";
				case 2 : return "Material Lifetime in years";
				case 3 : return "Absolute replacement count within LCA period";
				case 4 : return "??? TODO";
				case 5 : return "??? TODO";
			} break;
			// LCAPeriod::flag_t
