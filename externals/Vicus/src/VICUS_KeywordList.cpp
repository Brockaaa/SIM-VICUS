	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			switch (t) {
				...
				case 4 : return "HeatLoss";
				case 5 : return "HeatFlux";
				case 6 : return "FloorArea";
				case 7 : return "MaximumHeatingLoad";
				case 8 : return "HeatingEnergyDemand";
				case 9 : return "HeatingEnergyDemandAreaSpecific";
				case 10 : return "MaximumCoolingLoad";
				case 11 : return "CoolingEnergyDemand";
				case 12 : return "CoolingEnergyDemandAreaSpecific";
				case 13 : return "DomesticHotWaterDemand";
				case 14 : return "DomesticHotWaterDemandAreaRelated";
			} break;
			// NetworkNode::NodeType
			case 57 :
			switch (t) {
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			switch (t) {
				...
				case 3 : return "Temperature for heat exchange";
				case 4 : return "Constant heat flux out of the element (heat loss)";
				case 5 : return "TODO";
				case 6 : return "FloorArea";
				case 7 : return "MaximumHeatingLoad";
				case 8 : return "HeatingEnergyDemand";
