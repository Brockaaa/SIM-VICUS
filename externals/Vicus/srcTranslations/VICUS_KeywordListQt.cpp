...
KeywordListQt::KeywordListQt() {
	...
	tr("Simple pipe with single fluid volume");
	tr("Detailled pipe with discretized fluid volume");
	tr("Pump with constant pressure head");
	tr("Pump with defined mass flux");
	tr("Pump with controlled pressure head");
	tr("Pump with linear pressure head");
	tr("Simple heat exchanger");
	tr("Simple heat pump installed at evaporator (source) side, based on carnot efficiency");
	tr("Simple heat pump installed at condenser (supply) side, based on carnot efficiency");
	tr("Detailled heat pump installed at evaporator (source) side, based on polynom for COP");
	tr("Detailled heat pump (on-off) at evaporator (source) source side, based on polynoms for heating power and el. power");
	tr("Controlled valve");
	...
	tr("Hydraulic diameter");
	tr("Pressure loss coefficient (zeta)");
	tr("Predefined pressure head");
	tr("Predefined mass flux");
	tr("Efficiency in optimal operation");
	tr("Fraction of losses that heats up fluid");
	tr("Maximum pressure head at minimal mass flow");
	tr("Maximum electrical power at optimal operation");
	tr("Design pressure head");
	tr("Design mass flux");
	tr("Pressure head reduction at zero mass flux");
	tr("Volume");
	tr("Discretization length");
	tr("Carnot effectiveness");
	tr("Maximum heating power");
	tr("Maximum cooling power");
	tr("Pressure loss");
	tr("Minimum outlet temperature");
	...
	tr("Time-dependent heat loss");
	tr("Constant heating demand");
	tr("Time-dependent heating demand");
