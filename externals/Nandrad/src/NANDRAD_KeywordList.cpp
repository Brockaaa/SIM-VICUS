...
namespace NANDRAD {
	...
	const char * const ENUM_TYPES[86] = {
		...
		"InternalMoistureLoadsModel::modelType_t",
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			switch (t) {
				...
				case 7 : return "Heat loss from spline";
				case 8 : return "Constant heating demand";
				case 9 : return "Heat loss of condenser in heat pump model";
			...
			switch (t) {
				...
				case 2 : return "Scheduled basic air exchange (infiltration) with an additional increased air exchange (ventilation) if the (constant) control conditions are met.";
