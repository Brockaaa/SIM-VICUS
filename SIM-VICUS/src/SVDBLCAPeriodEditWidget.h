...
#ifndef SVDBLCAPeriodEditWidgetH
#define SVDBLCAPeriodEditWidgetH

#include "SVAbstractDatabaseEditWidget.h"

namespace Ui {
	class SVDBLCAPeriodEditWidget;
}
...
*/
class SVDBLCAPeriodEditWidget : public SVAbstractDatabaseEditWidget {
	Q_OBJECT
