...
#ifndef SVDBPIPESELECTIONTABLEMODEL_H
#define SVDBPIPESELECTIONTABLEMODEL_H

#include "SVAbstractDatabaseEditWidget.h"

#include "SVDatabase.h"

class SVDBPipeSelectionTableModel: public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBPipeSelectionTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_Pipes; }
...
#endif // SVDBPIPESELECTIONTABLEMODEL_H
