...
SVDBNetworkControllerEditWidget::SVDBNetworkControllerEditWidget(QWidget *parent, SVDatabase * db) :
    QDialog(parent),
...
void SVDBNetworkControllerEditWidget::setup(VICUS::BMBlock *block, VICUS::NetworkController controller, VICUS::NetworkComponent *networkComponent){
...
void SVDBNetworkControllerEditWidget::setController(VICUS::NetworkController *controller) {
...
void SVDBNetworkControllerEditWidget::on_buttonBox_accepted()
{
...
void SVDBNetworkControllerEditWidget::on_buttonBox_rejected()
{
    this->close();
}
